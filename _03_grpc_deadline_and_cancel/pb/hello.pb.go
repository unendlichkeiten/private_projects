...
var file_hello_proto_rawDesc = []byte{
	...
	0x30, 0x32, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x64, 0x65, 0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65,
	...
	0x61, 0x72, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x21, 0x2e, 0x5f, 0x30, 0x32, 0x5f, 0x67,
	...
	0x32, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x64, 0x65, 0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65, 0x5f,
	...
	0x6f, 0x12, 0x21, 0x2e, 0x5f, 0x30, 0x32, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x64, 0x65, 0x61,
	0x64, 0x6c, 0x69, 0x6e, 0x65, 0x5f, 0x61, 0x6e, 0x64, 0x5f, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c,
	0x2e, 0x52, 0x65, 0x71, 0x1a, 0x21, 0x2e, 0x5f, 0x30, 0x32, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x5f,
	0x64, 0x65, 0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65, 0x5f, 0x61, 0x6e, 0x64, 0x5f, 0x63, 0x61, 0x6e,
	0x63, 0x65, 0x6c, 0x2e, 0x52, 0x65, 0x73, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x07, 0x5a,
...
var file_hello_proto_goTypes = []interface{}{
	(*Req)(nil), // 0: _02_grpc_deadline_and_cancel.Req
	(*Res)(nil), // 1: _02_grpc_deadline_and_cancel.Res
}
var file_hello_proto_depIdxs = []int32{
	0, // 0: _02_grpc_deadline_and_cancel.Chat.UnaryHello:input_type -> _02_grpc_deadline_and_cancel.Req
	0, // 1: _02_grpc_deadline_and_cancel.Chat.BiStreamHello:input_type -> _02_grpc_deadline_and_cancel.Req
	1, // 2: _02_grpc_deadline_and_cancel.Chat.UnaryHello:output_type -> _02_grpc_deadline_and_cancel.Res
	1, // 3: _02_grpc_deadline_and_cancel.Chat.BiStreamHello:output_type -> _02_grpc_deadline_and_cancel.Res
...
func (c *chatClient) UnaryHello(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Res, error) {
	out := new(Res)
	err := c.cc.Invoke(ctx, "/_02_grpc_deadline_and_cancel.Chat/UnaryHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatClient) BiStreamHello(ctx context.Context, opts ...grpc.CallOption) (Chat_BiStreamHelloClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Chat_serviceDesc.Streams[0], "/_02_grpc_deadline_and_cancel.Chat/BiStreamHello", opts...)
	if err != nil {
		return nil, err
	}
...
func _Chat_UnaryHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/_02_grpc_deadline_and_cancel.Chat/UnaryHello",
	}
...
var _Chat_serviceDesc = grpc.ServiceDesc{
	ServiceName: "_02_grpc_deadline_and_cancel.Chat",
