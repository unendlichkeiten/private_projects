...
var file_mysql_proto_rawDesc = []byte{
	...
	0x30, 0x32, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x64, 0x65, 0x6d, 0x6f, 0x22, 0x1c, 0x0a, 0x08,
	...
	0x64, 0x12, 0x17, 0x2e, 0x5f, 0x30, 0x32, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x64, 0x65, 0x6d,
	0x6f, 0x2e, 0x4d, 0x79, 0x73, 0x71, 0x6c, 0x52, 0x65, 0x71, 0x1a, 0x17, 0x2e, 0x5f, 0x30, 0x32,
	...
	0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x17, 0x2e, 0x5f, 0x30, 0x32, 0x5f, 0x67, 0x72, 0x70, 0x63,
	0x5f, 0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x4d, 0x79, 0x73, 0x71, 0x6c, 0x52, 0x65, 0x71, 0x1a, 0x17,
	0x2e, 0x5f, 0x30, 0x32, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x4d,
	...
	0x32, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x4d, 0x79, 0x73, 0x71,
	0x6c, 0x52, 0x65, 0x71, 0x1a, 0x17, 0x2e, 0x5f, 0x30, 0x32, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x5f,
...
var file_mysql_proto_goTypes = []interface{}{
	(*MysqlReq)(nil), // 0: _02_grpc_demo.MysqlReq
	(*MysqlRes)(nil), // 1: _02_grpc_demo.MysqlRes
}
var file_mysql_proto_depIdxs = []int32{
	0, // 0: _02_grpc_demo.MysqlService.SelectRecord:input_type -> _02_grpc_demo.MysqlReq
	0, // 1: _02_grpc_demo.MysqlService.InsertRecord:input_type -> _02_grpc_demo.MysqlReq
	0, // 2: _02_grpc_demo.MysqlService.DeleteRecord:input_type -> _02_grpc_demo.MysqlReq
	0, // 3: _02_grpc_demo.MysqlService.UpdateRecord:input_type -> _02_grpc_demo.MysqlReq
	1, // 4: _02_grpc_demo.MysqlService.SelectRecord:output_type -> _02_grpc_demo.MysqlRes
	1, // 5: _02_grpc_demo.MysqlService.InsertRecord:output_type -> _02_grpc_demo.MysqlRes
	1, // 6: _02_grpc_demo.MysqlService.DeleteRecord:output_type -> _02_grpc_demo.MysqlRes
	1, // 7: _02_grpc_demo.MysqlService.UpdateRecord:output_type -> _02_grpc_demo.MysqlRes
...
func (c *mysqlServiceClient) SelectRecord(ctx context.Context, in *MysqlReq, opts ...grpc.CallOption) (*MysqlRes, error) {
	out := new(MysqlRes)
	err := c.cc.Invoke(ctx, "/_02_grpc_demo.MysqlService/SelectRecord", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mysqlServiceClient) InsertRecord(ctx context.Context, opts ...grpc.CallOption) (MysqlService_InsertRecordClient, error) {
	stream, err := c.cc.NewStream(ctx, &_MysqlService_serviceDesc.Streams[0], "/_02_grpc_demo.MysqlService/InsertRecord", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *mysqlServiceClient) DeleteRecord(ctx context.Context, in *MysqlReq, opts ...grpc.CallOption) (MysqlService_DeleteRecordClient, error) {
	stream, err := c.cc.NewStream(ctx, &_MysqlService_serviceDesc.Streams[1], "/_02_grpc_demo.MysqlService/DeleteRecord", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *mysqlServiceClient) UpdateRecord(ctx context.Context, opts ...grpc.CallOption) (MysqlService_UpdateRecordClient, error) {
	stream, err := c.cc.NewStream(ctx, &_MysqlService_serviceDesc.Streams[2], "/_02_grpc_demo.MysqlService/UpdateRecord", opts...)
	if err != nil {
		return nil, err
	}
...
func _MysqlService_SelectRecord_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/_02_grpc_demo.MysqlService/SelectRecord",
	}
...
var _MysqlService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "_02_grpc_demo.MysqlService",
